...
document.addEventListener("click", (e)=>{
    ...
    x = Math.max(0, Math.min(e.offsetX - spider.offsetWidth / 2, wall.clientWidth - spider.offsetWidth));
    y = Math.max(0, Math.min(e.offsetY - spider.offsetHeight / 2, wall.clientHeight - spider.offsetHeight));
